...
public class RequestorCompleteProfileJPanel extends javax.swing.JPanel {
    ...
    RequestorCompleteProfileJPanel(JPanel userProcessContainer, UserAccount account, WorkRequest workrequest) {
        ...
        lblage.setText(String.valueOf(workrequest.getSender().getPerson().getAge()));
        ...
        //To display image
        ImageIcon MyImage = new ImageIcon(System.getProperty("user.dir")+File.separator+workrequest.getSender().getPerson().getImageURL());
