 ...
 * @author Sudeep
 */
public class MilitaryFinanceAdminManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public MilitaryFinanceAdminManageUserAccountJPanel(JPanel userProcessContainer, UserAccount account, MilitaryFinanceOrganization organization, Enterprise enterprise, EcoSystem business) {
        initComponents();
...
//    }
    ...
    public void populateEmployeeComboBox(MilitaryFinanceOrganization organization){
        employeeJComboBox.removeAllItems();
    ...
    private void populateRoleComboBox(MilitaryFinanceOrganization e){
